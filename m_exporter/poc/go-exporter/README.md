...
| メトリクス名                                              | 型      | ラベル | 内容                                  |
| --------------------------------------------------------- | ------- | ------ | ------------------------------------- |
| `m_exporter_cpu_usage_{ratio,percent}`                    | Gauge   | `cpu`  | per-core 使用率（unit に応じて 0-1 / 0-100）、`cpu="total"` も |
...
| `m_exporter_memory_used_{ratio,percent}`                  | Gauge   | -      | 使用率（unit に応じて 0-1 / 0-100）   |
| `m_exporter_swap_total_bytes`                             | Gauge   | -      | swap 総量                             |
| `m_exporter_swap_used_bytes`                              | Gauge   | -      | swap 使用                             |
| `m_exporter_swap_used_{ratio,percent}`                    | Gauge   | -      | swap 使用率（unit に応じて 0-1 / 0-100）|
